...
ALTER TABLE ride_offers ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE ride_requests ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE join_requests ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE ride_request_offers ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE ride_matches ALTER COLUMN id RESTART WITH 1000;
